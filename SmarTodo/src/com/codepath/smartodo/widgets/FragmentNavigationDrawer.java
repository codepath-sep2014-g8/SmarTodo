...
public class FragmentNavigationDrawer extends DrawerLayout{
	...
	private ActionBarDrawerToggle acToggle;
	...
	public void setupDrawerConfiguration(ListView drawerListView, int drawerItemRes, int drawerContainerRes) {
		...
		adapter = new ArrayAdapter<String>(getActivity(), drawerItemRes, new ArrayList<String>());
		...
		acToggle = setupDrawerToggle();
		setDrawerListener(acToggle);
